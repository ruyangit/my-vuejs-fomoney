<template>
    ...
    <div class="item yfkpt active">
        ...
        <div class="txt-content">
            <p class="txt-p">云审批决策服务旨在帮助小额贷款公司、网络金融平台、汽车金融公司、消费金融公司等金融或类金融机构进行前端风险管理。通过对客户申请信息与外部数据的比对，识别客户的欺诈风险；进而通过大数据挖掘技术，客观评估客户信用风险，预测违约概率。此外，云风控平台还将基于进件的风险高低对其准入，风险定价以及授信额度给出决策建议。
            </p>
            <h4>云审批决策服务可帮助您</h4>
            <p>1）标准化审批流程</p>
