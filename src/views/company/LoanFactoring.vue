<template>
    <div class="item blyw active">
        ...
        <div class="txt-content">
            ...
            <h4>应收账款管理与催收</h4>
            <p>从卖方将货物或服务提供给买方，自债权成立开始，到款项实际收回或作为坏账处理结束，星联保理运用企业开发的账务管理系统和综合工具，对应收账款回收全过程进行的管理。其目的是保证足额、及时收回应收账款，降低和避免企业的信用风险和经营风险。</p>
            <h4>买方信用额度担保</h4>
            <p>星联保理根据买方的资信情况，给予买方核定具体的授信额度，在此额度内核心客户（卖方）如因买方原因无法正常收款，星联保理可以全额赔付。</p>
        </div>
        <div class="btn-box">
