  ...
  <div style="position:relative;">
      ...
      <div class="eti">
         ...
         <div class="detail-content">
            <p class="introduce"><a>电子发票</a>是随着社会不断进步、网络高速发展以及电子商务快速崛起而产生的，在电子发票上附有电子税局的签名机制，而税局则通过电子发票数据的产生、流转、查验和应用，实现“以票控税”向“信息管税”的过渡。复星金服电子发票服务，助力复星ONE FOSUN战略，从价值链形成服务闭环到形成开放的生态圈，强化产业能力和用户服务能力。</p>
            ...
            <ul>
              ...
              <li>
                ...
                <span class="fr right">实现所有开票环节向线上迁移，优化客户体验增加企业运营效率；多层级机构开票数据统一汇总统一管理，为企业快速决策提供依据。</span>
              </li>
              <li>
                <span class="fl left">稳</span>
                <span class="fr right">采用多种身份认证，全方位、高科技保证企业数据安全；支持复杂的业务系统无缝对接以满足企业内控需求；有效规避传统票据在传递中可能产生的税收管理风险。</span>
              </li>
            </ul>
            ...
            <ol>
              ...
              <li>
                <p class="title">定制化</p>
                <p class="detail">具备强大的技术力量，根据企业的不同特性提供贴合业务需求的解决方案</p>
              </li>
              <li>
                <p class="title">便捷化</p>
