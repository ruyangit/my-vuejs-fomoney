    ...
    <div>
        ...
        <transition name="fade">
            <div class="modal-common enter-alert-details" v-show="al5" @click="zDetarget('al5')">
                ...
                <h2>星灵资产</h2>
                <p>上海星灵资产管理有限公司是（复星集团旗下）一家专注于打造具有产业深度的、多维生态圈以及为各种非标资产提供流动性的综合互联网投融资平台。星灵资产的核心价值观是：以价值投资的理念为指导，以领先的风控和金融手段为保障，筛选出优质资产，为投资人提供不一样的财富管理体验。</p>
            </div>
        </transition>
        <transition name="fade">
            <div class="modal-common enter-alert-details" v-show="al6" @click="zDetarget('al6')">
                ...
                <h2>量富征信</h2>
                <p>量富征信管理有限公司是（复星集团旗下）一家独立的第三方征信公司，主营业务为企业征信，并已获得企业征信业务经营备案证。融合集团内外各类数据，采用国内外领先的建模技术，推出四大征信产品：企业征信解决方案、云风控平台、反欺诈产品和信用风险管理咨询，并与金融风控，供应链管理，旅游一体化等领域的众多机构建立深入合作。</p>
            </div>
        </transition>
        <transition name="fade">
         ...
         <transition name="fade">
            <div class="modal-common enter-alert-details" v-show="al8" @click="zDetarget('al8')">
                ...
                <h2>投资团队</h2>
                <p>复星金服的投资团队是复星集团旗下专注于全球银行、信托、融资租赁、金融科技等相关领域投资的专业团队，现有投资成员20人，服务于复星集团整体战略目标，从全球化、互联网、综合金融能力三个维度，建立复星集团的银行类资产体系，为股东获取回报。</p>
            </div>
        </transition>
    </div>
</template>
